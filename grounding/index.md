...
| IDX-003 | Definitions Registry | DEF-001…DEF-019 (APPROVED v1.0; DEF-012/013 v1.1 mappings final; DEF-014 v1.1; DEF-018 v1.1 order-level pending semantics) — rounding law, revenue recognition, cleaning rules, dedupe, metrics | grounding | grounding/definitions.md |
...
| IDX-014 | Gold Layer (pending QA) | oakhaven_gold: fact_order_lines/fact_orders + 4 dims + 5 marts live; V01-V05 reconcile to B05 (83,160,177.98 exact) and DEF-014 (11,866 canonical customers); Q01-Q12 feed reports R1-R3; validator PASS WITH WARNINGS (0 blocking); 2 MISSING DEFINITIONS escalated (loyalty-tier normalization, unit margin) — gate TASK-05; verdict pending (PR merge = approval) | deliverable | medallion/c_gold/ |
