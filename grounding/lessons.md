...
- RULE-010: Multi-line SQL goes through a file (mysql < file.sql), not -e string quoting, once a query exceeds one line — PowerShell quoting mangles multi-line strings. | oakhaven build session | 2026-07-04
