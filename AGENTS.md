...
The database file is `.gitignore`d and regenerated by anyone who clones
the repo. When working in this repo (especially if multiple agents or
processes might touch it concurrently):
